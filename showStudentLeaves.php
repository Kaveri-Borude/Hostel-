  ...
  ?>
<head>
    <title>showStudentLeaves.php</title>
   ...
   <script>
     ...
     <?php     
      if(isset($_POST['showStudentLeaves'])){
         $sId = $_POST['showStudentLeaves'];
      } else{
         echo "Not Set";
         exit;
      }
     ...
     <div class="container col-10 offset-1 mt-5 "><br>
            ...
            ?>
                ...
                <div class="search"> <h4 style="margin-top:8px; text-align: center">   <?php echo "Leave Record : $sName"?> </h4>        
            ...
            <!-- retrieve Info. From DB -->
                ...
                $query1 = "Select * from leave_data where sId = $sId AND reason = 'leave' order by leaveNo desc";
                $result1 = $con->query($query1);
                    ...
                    if($result1->num_rows > 0){
                                   ...
                                   echo '<tbody id="myTable">';      
                                        ...
                                        // }
                                         ...
                                         echo "<td> ";
                                               ...
                                               if($res['inDate'] == null){
                                                 echo "<form action='closeLeaveEntry.php' method='post' > 
                         ...
                         echo'<br><div> <h4 style="margin-top:8px; text-align: center">  No Leave Record Found   </h4><hr> <br>';
                    }
