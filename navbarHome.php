...
<body>
   ...
   <nav class="navbar border-bottom container-fluid sticky-top ">
        ...
        <a class="navbar-brand navIcon" href="/"><i class="fa-regular fa-compass"></i></a>
            ...
            <a class="btn nItm me-2" id="gotoMain">Main Page</a>
            
            <?php
                if(isset($_SESSION['staffName'] )){
                     echo'<a class="btn nItm" href="/KDAJ-PHP/Hostel_Management/HomePage/Home.php">Home Page</a>';
                }elseif(isset($_SESSION['AName'] )){
                    echo'<a class="btn nItm" href="/KDAJ-PHP/Hostel_Management/MainAuthority/AuthorityHome.php">Home Page</a>';
                }

                if(isset($_SESSION['staffName'] )){
                     echo'<form action ="/KDAJ-PHP/Hostel_Management/HomePage/showAllStudents.php" method="post">
            ...
            <?php
                 if(isset($_SESSION['staffName'] )){
                        echo "<div class='profile me-1 ms-auto'> 
                                     <p> Welcome ".$_SESSION['staffName'] ."</p> 
                                     <i class='fa-solid fa-user fa-2x me-2'></i>
                                    
                                     <a class='navIcon' href='../HomePage/logout.php'><i class='fa-solid fa-right-from-bracket'></i></a> 
                        </div>";
                 }elseif(isset($_SESSION['AName'])){
                        echo "<div class='profile me-1 ms-auto'> 
                    ...
                    header("Location: ../MainPage/loginStaff1.php");
                    exit();
                }
            ?>
