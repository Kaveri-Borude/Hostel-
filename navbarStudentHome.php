...
<head>
    ...
    <title>Home.html</title>
     ...
     <style>
           ...
           body {
             padding-top: 19px; /* adjust based on navbar height */ 
           }
...
<body>
   ...
   <nav class="navbar border-bottom container-fluid sticky-top ">
        ...
        <a class="navbar-brand navIcon" href="/"><i class="fa-regular fa-compass"></i></a>
            ...
            <a class="btn nItm" href="/KDAJ-PHP/Hostel_Management/StudentHome/StudentHome.php">Home Page</a>

            <?php
                 if(isset($_SESSION['sName'] )){
                        echo "<div class='profile me-1 ms-auto'> 
                                     <p> Welcome ".$_SESSION['sName'] ."</p> 
                 ...
                 if(!isset($_SESSION['sName'])){
                    header("Location: ../MainPage/loginStudent1.php");
                    exit();
                }
            ?>
